...
const PROVIDER_KEY_LABELS: Record<string, string> = {
  ...
  usdc: 'admin.settings.payment.providerUsdc',
}
...
const modeLabel = computed(() => {
  ...
  if (props.provider.payment_mode === PAYMENT_MODE_POPUP || props.provider.payment_mode === PAYMENT_MODE_REDIRECT) return t('admin.settings.payment.modePopup')
  return ''
})
