...
describe('admin UsersView', () => {
  ...
  it('keeps API concurrency visible even when old column preferences hid it', async () => {
    localStorage.setItem('user-hidden-columns', JSON.stringify(['concurrency', 'last_active_at', 'usage']))
    ...
    expect(visibleColumns).not.toContain('usage')
  })
})
