...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          ProfileSubscriptionOverageCard: { template: '<div data-testid="profile-subscription-overage-card" />' },
    ...
    expect(wrapper.get('[data-testid="profile-shell"]').html()).toContain('profile-subscription-overage-card')
