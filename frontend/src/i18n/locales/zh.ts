export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    preferredSubscriptionLabel: 'Claude 扣费套餐',
    autoSubscriptionBilling: '自动选择',
    preferredSubscriptionHint: '拥有多个有效套餐时，可指定 Claude 优先扣哪个套餐；自动选择会按当前规则使用可用额度最高的套餐。',
    subscriptionOptionWithUsage: '{name} · 已用 {used}/{limit} USD',
    subscriptionOptionUnlimited: '{name} · 不限额',
    claudeBillingColumn: 'Claude扣费',
    claudeBillingPlan: 'Claude 扣费订阅',
    claudeBillingAuto: '自动选择',
    claudeBillingManual: '手动指定',
    claudeBillingPlanFirst: '套餐优先',
    claudeBillingCurrent: '当前扣费：{name}',
    claudeBillingAutoCurrent: '自动选择：{name}',
    noClaudeBillingSubscription: '当前无可用于 Claude 扣费的套餐，请购买或续费套餐。',
    oldClaudeSubscriptionNotSelectable: '当前 Claude 订阅可直接用于扣费。',
    claudeLegacySubscriptionStatus: '订阅可用',
    claudeBalanceBillingActive: '余额计费中',
    claudeBalanceBillingText: '未绑定套餐时 Claude 会直接扣账户余额。当前余额 ${balance}',
    claudeBillingUnavailable: '无法扣费',
    claudeNoBalanceBillingText: '当前没有可用套餐，且账户余额不足。请充值余额或购买套餐后再使用 Claude。',
    claudeOveragePayg: '套餐用完扣余额',
    claudeOveragePaygOn: '已开启',
    claudeOveragePaygOff: '未开启',
    claudeOveragePaygHint: '开启后：订阅额度内扣套餐；套餐日/周/月额度用完后自动扣账户余额。',
    claudeOveragePaygEnabledText: '套餐额度用完后会自动扣账户余额。',
    claudeOveragePaygDisabledText: '套餐额度用完后会停止请求，不会继续扣余额。',
    claudeOveragePaygSaved: 'Claude 超额扣余额设置已保存',
    failedToUpdateClaudeOveragePayg: '更新 Claude 超额扣余额设置失败',
    claudeBillingGuideTitle: 'Claude 计费方式',
    claudeBillingBalance: '账户余额',
    claudeBillingAvailablePlans: '可扣套餐',
    claudeBillingAvailablePlanCount: '{count} 个套餐',
    claudeBillingGuidePlanWithFallback: 'Claude 优先扣你选择的套餐；套餐额度用完后会自动切到账户余额。',
    claudeBillingGuidePlanNoFallback: 'Claude 优先扣你选择的套餐；套餐额度用完后当前不会扣余额，会直接停止请求。',
    claudeBillingPlanUpdated: 'Claude 扣费套餐已更新',
    failedToUpdateClaudeBillingPlan: '更新 Claude 扣费套餐失败',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
  ...
  affiliate: {
    title: '邀请返利',
    description: '邀请新用户注册，返佣金额以人民币计，可按充值倍率兑换到账户余额',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '被邀请用户充值或订阅后你可获得的返佣比例',
      invitedUsers: '邀请人数',
      availableQuota: '可用返佣（人民币）',
      frozenQuota: '冻结返佣',
      frozenQuotaHint: '新产生的返佣正在冻结期中',
      totalQuota: '累计返佣（人民币）'
    },
    transfer: {
      title: '人民币返佣转余额',
      description: '将当前可用返佣按余额充值倍率兑换到账户余额，可用于余额消费或订阅支付',
      button: '转入余额',
      transferring: '转入中...',
      empty: '当前没有可转入额度',
      success: '已将 {amount} 人民币返佣兑换到账户余额'
    },
    invitees: {
      title: '已邀请用户',
      empty: '暂无邀请记录',
    ...
    tips: {
      ...
      line2: '被邀请用户充值或购买订阅后，你可获得 {rate} 的人民币返佣。',
      line3: '返佣金额可按充值倍率转入账户余额。',
      line4: '新产生的返佣需要经过冻结期后才能转入余额。'
    }
  },
  ...
  admin: {
    ...
    subscriptions: {
      ...
      maxValidityHint: '最多 36500 天',
      dayPreset: '{days} 天',
      daysUnit: '天',
      expiryPreview: '预计到期：{date}',
      ...
      resetQuotaFor: '重置用户：',
      resetQuotaConfirm: '请选择要归零的订阅用量窗口，点击后立即执行。不会默认全部重置，只会重置你点击的窗口。',
      resettingQuota: '重置中...',
      resetQuotaScopes: {
        daily: '日限额',
        dailyDesc: '仅归零每日已用额度，周/月用量保持不变',
        weekly: '周限额',
        weeklyDesc: '仅归零每周已用额度，日/月用量保持不变',
        monthly: '月限额',
        monthlyDesc: '仅归零每月已用额度，日/周用量保持不变',
        all: '全部重置',
        allDesc: '同时归零日、周、月已用额度'
      },
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '老用户邀请新用户注册，新用户充值或订阅后老用户按比例获得人民币返佣。默认关闭。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新充值和订阅不再产生返佣。已有返佣金额仍可转入余额。',
          rebateRate: '全局返利比例',
          rebateRateHint: '充值或订阅后返给邀请人的默认比例（0-100%，例如填写 10 表示返佣 10%）。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的返佣将在冻结期内无法转入余额。0 = 不冻结。',
          durationDays: '返利有效期（天）',
          durationDaysDesc: '被邀请用户注册后多少天内的充值和订阅产生返佣。0 = 永久有效。',
          perInviteeCap: '单人返佣上限（人民币）',
          perInviteeCapDesc: '每个被邀请用户最多产生的人民币返佣总额。0 = 无上限。',
          inviteeRebates: {
            title: '邀请充值/订阅明细',
            description: '按被邀请用户展示已完成余额充值、付费订阅和实际产生的人民币返佣金额。',
            searchPlaceholder: '搜索邀请人、被邀请人或邀请码',
            empty: '暂无邀请充值或订阅记录',
      ...
      payment: {
        ...
        field_address: '收款地址',
        field_network: '网络',
        field_cnyPerUsdc: '人民币/USDC 汇率',
        field_memoPrefix: '订单备注前缀',
        field_qrTemplate: '二维码模板',
        field_cid: '支付渠道 ID',
  ...
  userSubscriptions: {
    ...
    usageDashboard: {
      title: '订阅用量看板',
      description: '按日、周、月分别汇总当前有效订阅的额度使用比例，比例精确到 1%。',
      ...
      nearLimit: '接近上限',
      noActive: '暂无有效订阅',
      noActiveDescription: '当前没有处于有效期内的订阅套餐，购买或续费后会显示日、周、月额度比例。',
      unlimited: '当前订阅未设置额度上限',
      unlimitedDescription: '有效订阅没有配置日、周、月额度限制，可按套餐规则继续使用。'
    }
  },
