export default {
  ...
  nav: {
    ...
    kiroAccountStatus: 'Kiro Account Management',
  ...
  keys: {
    ...
    preferredSubscriptionLabel: 'Claude billing plan',
    autoSubscriptionBilling: 'Auto select',
    preferredSubscriptionHint: 'When you have multiple active plans, choose which plan Claude should bill first. Auto uses the current highest-quota rule.',
    subscriptionOptionWithUsage: '{name} · used {used}/{limit} USD',
    subscriptionOptionUnlimited: '{name} · unlimited',
    claudeBillingColumn: 'Claude billing',
    claudeBillingPlan: 'Claude billing plan',
    claudeBillingAuto: 'Auto select',
    claudeBillingManual: 'Manual',
    claudeBillingPlanFirst: 'Plan first',
    claudeBillingCurrent: 'Billing now: {name}',
    claudeBillingAutoCurrent: 'Auto selected: {name}',
    noClaudeBillingSubscription: 'No plan is available for Claude billing. Please purchase or renew a plan.',
    oldClaudeSubscriptionNotSelectable: 'The Claude subscription can be used for billing directly.',
    claudeLegacySubscriptionStatus: 'Plan available',
    claudeBalanceBillingActive: 'Balance billing',
    claudeBalanceBillingText: 'Without a bound plan, Claude bills account balance directly. Current balance ${balance}',
    claudeBillingUnavailable: 'Unavailable',
    claudeNoBalanceBillingText: 'No usable plan is available and account balance is insufficient. Top up balance or buy a plan before using Claude.',
    claudeOveragePayg: 'Use balance after quota',
    claudeOveragePaygOn: 'On',
    claudeOveragePaygOff: 'Off',
    claudeOveragePaygHint: 'When enabled, Claude uses plan quota first, then account balance after daily/weekly/monthly quota is exhausted.',
    claudeOveragePaygEnabledText: 'After plan quota is exhausted, requests continue using account balance.',
    claudeOveragePaygDisabledText: 'After plan quota is exhausted, requests stop instead of using balance.',
    claudeOveragePaygSaved: 'Claude overage balance setting saved',
    failedToUpdateClaudeOveragePayg: 'Failed to update Claude overage balance setting',
    claudeBillingGuideTitle: 'Claude billing mode',
    claudeBillingBalance: 'Account balance',
    claudeBillingAvailablePlans: 'Billable plans',
    claudeBillingAvailablePlanCount: '{count} plans',
    claudeBillingGuidePlanWithFallback: 'Claude bills the selected plan first, then switches to account balance after quota is exhausted.',
    claudeBillingGuidePlanNoFallback: 'Claude bills the selected plan first. After quota is exhausted, requests stop instead of using balance.',
    claudeBillingPlanUpdated: 'Claude billing plan updated',
    failedToUpdateClaudeBillingPlan: 'Failed to update Claude billing plan',
    statusLabel: 'Status',
  ...
  affiliate: {
    ...
    description: 'Invite new users and convert CNY-denominated rebates into account balance',
    ...
    stats: {
      ...
      rebateRateHint: 'What you earn when an invitee recharges or subscribes',
      invitedUsers: 'Invited Users',
      availableQuota: 'Available Rebate (CNY)',
      frozenQuota: 'Frozen Rebate',
      frozenQuotaHint: 'Recently earned rebates pending release',
      totalQuota: 'Total Rebate (CNY)'
    },
    transfer: {
      title: 'Convert CNY Rebate to Balance',
      description: 'Convert available rebate into account balance using the balance recharge multiplier',
      button: 'Transfer to Balance',
      transferring: 'Transferring...',
      empty: 'No available rebate quota',
      success: '{amount} rebate has been converted into your account balance'
    },
    invitees: {
      title: 'Invited Users',
      ...
      columns: {
        email: 'Email',
        username: 'Username',
        recharged: 'Top-up/Subscription (CNY)',
        rebate: 'Rebate (CNY)',
        joinedAt: 'Joined At'
      }
    },
    tips: {
      ...
      line2: 'When invitees recharge or subscribe, you receive {rate} as a CNY rebate.',
      line3: 'Convert rebate into balance using the recharge multiplier.',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      maxValidityHint: 'Max 36500 days',
      dayPreset: '{days} days',
      daysUnit: 'days',
      expiryPreview: 'Estimated expiry: {date}',
      ...
      resetQuotaFor: 'Reset user:',
      resetQuotaConfirm: 'Choose the subscription usage window to reset. It runs immediately, does not default to all, and only resets the window you click.',
      resettingQuota: 'Resetting...',
      resetQuotaScopes: {
        daily: 'Daily limit',
        dailyDesc: 'Only zero daily usage; weekly and monthly usage stay unchanged',
        weekly: 'Weekly limit',
        weeklyDesc: 'Only zero weekly usage; daily and monthly usage stay unchanged',
        monthly: 'Monthly limit',
        monthlyDesc: 'Only zero monthly usage; daily and weekly usage stay unchanged',
        all: 'Reset all',
        allDesc: 'Zero daily, weekly, and monthly usage together'
      },
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter earns a CNY-denominated rebate on the invitee’s recharges and subscriptions. Disabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new recharges/subscriptions generate no rebate. Existing rebates can still be converted to balance.',
          rebateRate: 'Global Rebate Rate',
          rebateRateHint: 'Default percentage given back to the inviter on recharges or subscriptions (0-100, e.g. 10 = 10%).',
          freezeHours: 'Rebate Freeze Period (hours)',
          freezeHoursDesc: 'New rebates will be frozen for this period before they can be converted to balance. 0 = no freeze.',
          durationDays: 'Rebate Duration (days)',
          durationDaysDesc: 'Rebates are generated for this many days after invitee registration. 0 = permanent.',
          perInviteeCap: 'Per-Invitee Rebate Cap (CNY)',
          perInviteeCapDesc: 'Maximum total CNY rebate from a single invitee. 0 = no limit.',
          inviteeRebates: {
            title: 'Invitee Recharge/Subscription Records',
            description: 'Shows each invitee’s completed balance top-ups, paid subscriptions, and actual CNY rebate generated.',
            searchPlaceholder: 'Search inviter, invitee, or invite code',
            empty: 'No invitee recharge or subscription records yet',
      ...
      payment: {
        ...
        field_address: 'Receiving Address',
        field_network: 'Network',
        field_cnyPerUsdc: 'CNY per USDC',
        field_memoPrefix: 'Order Memo Prefix',
        field_qrTemplate: 'QR Template',
  ...
  userSubscriptions: {
    ...
    usageDashboard: {
      title: 'Subscription Usage Dashboard',
      description:
        'Aggregates active subscription usage by daily, weekly, and monthly quota windows with 1% precision.',
      ...
      noActiveDescription:
        'Daily, weekly, and monthly quota ratios will appear after a subscription is purchased or renewed.',
      unlimited: 'No quota limits configured',
      unlimitedDescription:
        'Active subscriptions do not have daily, weekly, or monthly quota caps configured.'
    }
  },
  ...
  payment: {
    ...
    admin: {
      ...
      group: 'Group',
      groupId: 'Group ID',
      includedGroups: 'Included Routes',
