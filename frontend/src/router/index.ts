...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/kiro',
    redirect: '/admin/channels/kiro'
  },
  {
    path: '/admin/channels/kiro',
  ...
  {
    path: '/admin/kiro/status',
    name: 'AdminKiroAccountStatus',
    component: () => import('@/views/admin/AccountsView.vue'),
    props: { accountScope: 'kiro' },
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Kiro Account Management',
      titleKey: 'nav.kiroAccountStatus'
    }
  },
  {
    path: '/admin/users',
