 ...
 * @param preferredSubscriptionGroupId - Optional subscription group for Claude billing (0/null = auto)
...
export async function create(
  ...
  preferredSubscriptionGroupId?: number | null
): Promise<ApiKey> {
  ...
  if (preferredSubscriptionGroupId !== undefined) {
    payload.preferred_subscription_group_id = preferredSubscriptionGroupId
  }
