...
// 2. True-Client-IP (Cloudflare Enterprise / 兼容代理)
// 3. X-Real-IP (Nginx)
// 4. X-Forwarded-For (取第一个非私有 IP)
// 5. c.ClientIP() (Gin 内置方法)
func GetClientIP(c *gin.Context) string {
	...
	// 4. X-Forwarded-For (多个 IP 时取第一个公网 IP)
