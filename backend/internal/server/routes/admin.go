...
func registerKiroRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	kiro := admin.Group("/kiro")
	{
		...
		kiro.POST("/login/start", h.Admin.Kiro.StartCLILogin)
		kiro.GET("/login/:id", h.Admin.Kiro.GetCLILoginSession)
	}
}
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/inactive-balance-cleanup/preview", h.Admin.User.PreviewInactiveBalanceCleanup)
		users.POST("/inactive-balance-cleanup/execute", h.Admin.User.ExecuteInactiveBalanceCleanup)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	{
		affiliates.GET("/invitees", h.Admin.Affiliate.ListInviteeRebates)
