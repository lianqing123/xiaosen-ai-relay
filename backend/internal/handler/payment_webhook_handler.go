...
// USDCWebhook handles standalone USDC payment notifications.
// POST /api/v1/payment/webhook/usdc
func (h *PaymentWebhookHandler) USDCWebhook(c *gin.Context) {
	h.handleNotify(c, payment.TypeUSDC)
}
