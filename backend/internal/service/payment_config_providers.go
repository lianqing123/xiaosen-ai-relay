...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeStripe:  {"secretkey": {}, "webhooksecret": {}},
	payment.TypeUSDC:    {"address": {}, "network": {}, "cnyperusdc": {}, "webhooksecret": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeUSDC: true,
}
