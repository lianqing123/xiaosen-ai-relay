...
const apiKeyAuthSnapshotVersion = 9 // v9: added preferred subscription group for route billing
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		PreferredSubscriptionGroupID: apiKey.PreferredSubscriptionGroupID,
		...
		User: APIKeyAuthUserSnapshot{
			...
			SubscriptionOveragePaygEnabled: apiKey.User.SubscriptionOveragePaygEnabled,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		PreferredSubscriptionGroupID: snapshot.PreferredSubscriptionGroupID,
		Key:                          key,
		...
		User: &User{
			...
			SubscriptionOveragePaygEnabled: snapshot.User.SubscriptionOveragePaygEnabled,
