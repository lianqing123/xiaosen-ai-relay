...
type APIKey struct {
	...
	Name    string
	GroupID *int64
	// PreferredSubscriptionGroupID lets a route key (for example Claude) choose
	// which active subscription package should pay for requests.
	PreferredSubscriptionGroupID *int64
	Status                       string
	IPWhitelist                  []string
	IPBlacklist                  []string
