...
func TestIsMigrationChecksumCompatible(t *testing.T) {
	t.Run("054 legacy checksum is accepted", func(t *testing.T) {
	...
	t.Run("054 unknown file checksum is rejected", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"054_drop_legacy_cache_columns.sql",
			"182c193f3359946cf094090cd9e57d5c3fd9abaffbc1e8fc378646b8a6fa12b4",
	...
	t.Run("061 first legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("061 second legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"061_add_usage_log_request_type.sql",
	...
	t.Run("non-whitelisted migrations stay incompatible", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"001_init.sql",
			"182c193f3359946cf094090cd9e57d5c3fd9abaffbc1e8fc378646b8a6fa12b4",
			"82de761156e03876653e7a6a4eee883cd927847036f779b0b9f34c42a8af7a7d",
	...
	t.Run("109 upstream legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("109 current checksum accepts upstream legacy db checksum", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"109_auth_identity_compat_backfill.sql",
			"551e498aa5616d2d91096e9d72cf9fb36e418ee22eacc557f8811cadbc9e20ee",
			"0580b4602d85435edf9aca1633db580bb3932f26517f75134106f80275ec2ace",
	...
	t.Run("109 rollback to legacy file stays compatible with current db checksum", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"109_auth_identity_compat_backfill.sql",
			"0580b4602d85435edf9aca1633db580bb3932f26517f75134106f80275ec2ace",
			"551e498aa5616d2d91096e9d72cf9fb36e418ee22eacc557f8811cadbc9e20ee",
	...
	t.Run("109 extra live-db checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"109_auth_identity_compat_backfill.sql",
	...
	t.Run("109 latest upstream checksum is accepted for the live-db checksum", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"109_auth_identity_compat_backfill.sql",
			"748ddcdc60f93a1ac562ce8a66ee870f64ee594bf6dbedad55ed8baf3c75b28c",
	...
	t.Run("110 legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("110 live-db checksum is accepted for the latest file", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"110_pending_auth_and_provider_default_grants.sql",
	...
	t.Run("112 legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("112 live-db checksum is accepted for the latest file", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"112_add_payment_order_provider_key_snapshot.sql",
	...
	t.Run("115 legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("116 legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("118 both known db checksums are accepted", func(t *testing.T) {
	...
	t.Run("118 live-db checksum is accepted for the latest file", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"118_wechat_dual_mode_and_auth_source_defaults.sql",
	...
	t.Run("119 legacy checksum is accepted", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
	...
	t.Run("120 all known db checksums are accepted", func(t *testing.T) {
		for _, dbChecksum := range []string{
	...
	t.Run("119 unknown file checksum is rejected", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"119_enforce_payment_orders_out_trade_no_unique.sql",
			"ebd2c67cce0116393fb4f1b5d5116a67c6aceb73820dfb5133d1ff6f36d72d34",
