...
func (r *apiKeyRepository) Create(ctx context.Context, key *service.APIKey) error {
	builder := r.client.APIKey.Create().
		...
		SetNillablePreferredSubscriptionGroupID(key.PreferredSubscriptionGroupID).
...
func (r *apiKeyRepository) GetByKeyForAuth(ctx context.Context, key string) (*service.APIKey, error) {
	m, err := r.activeQuery().
		...
		Select(
			...
			apikey.FieldUserID,
			apikey.FieldGroupID,
			apikey.FieldPreferredSubscriptionGroupID,
			apikey.FieldStatus,
		...
		WithUser(func(q *dbent.UserQuery) {
			q.Select(
				...
				user.FieldSubscriptionOveragePaygEnabled,
...
func (r *apiKeyRepository) Update(ctx context.Context, key *service.APIKey) error {
	...
	if key.PreferredSubscriptionGroupID != nil {
		builder.SetPreferredSubscriptionGroupID(*key.PreferredSubscriptionGroupID)
	} else {
		builder.ClearPreferredSubscriptionGroupID()
	}
...
func apiKeyEntityToService(m *dbent.APIKey) *service.APIKey {
	...
	out := &service.APIKey{
		...
		GroupID:                      m.GroupID,
		PreferredSubscriptionGroupID: m.PreferredSubscriptionGroupID,
		Quota:                        m.Quota,
...
func userEntityToService(u *dbent.User) *service.User {
	...
	out := &service.User{
		...
		SubscriptionOveragePaygEnabled: u.SubscriptionOveragePaygEnabled,
		RPMLimit:                       u.RpmLimit,
