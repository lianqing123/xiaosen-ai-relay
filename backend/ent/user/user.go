...
const (
	...
	// FieldSubscriptionOveragePaygEnabled holds the string denoting the subscription_overage_payg_enabled field in the database.
	FieldSubscriptionOveragePaygEnabled = "subscription_overage_payg_enabled"
...
var Columns = []string{
	...
	FieldTotalRecharged,
	FieldSubscriptionOveragePaygEnabled,
	FieldRpmLimit,
}
...
var (
	...
	// DefaultSubscriptionOveragePaygEnabled holds the default value on creation for the "subscription_overage_payg_enabled" field.
	DefaultSubscriptionOveragePaygEnabled bool
...
// BySubscriptionOveragePaygEnabled orders the results by the subscription_overage_payg_enabled field.
func BySubscriptionOveragePaygEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSubscriptionOveragePaygEnabled, opts...).ToFunc()
}
