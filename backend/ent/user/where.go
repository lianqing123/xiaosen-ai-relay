...
// SubscriptionOveragePaygEnabled applies equality check predicate on the "subscription_overage_payg_enabled" field. It's identical to SubscriptionOveragePaygEnabledEQ.
func SubscriptionOveragePaygEnabled(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldSubscriptionOveragePaygEnabled, v))
}
...
// SubscriptionOveragePaygEnabledEQ applies the EQ predicate on the "subscription_overage_payg_enabled" field.
func SubscriptionOveragePaygEnabledEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldSubscriptionOveragePaygEnabled, v))
}

// SubscriptionOveragePaygEnabledNEQ applies the NEQ predicate on the "subscription_overage_payg_enabled" field.
func SubscriptionOveragePaygEnabledNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldSubscriptionOveragePaygEnabled, v))
}
