...
type User struct {
	...
	// SubscriptionOveragePaygEnabled holds the value of the "subscription_overage_payg_enabled" field.
	SubscriptionOveragePaygEnabled bool `json:"subscription_overage_payg_enabled,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldSubscriptionOveragePaygEnabled:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldSubscriptionOveragePaygEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_overage_payg_enabled", values[i])
			} else if value.Valid {
				_m.SubscriptionOveragePaygEnabled = value.Bool
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("subscription_overage_payg_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.SubscriptionOveragePaygEnabled))
	builder.WriteString(", ")
