...
// SubscriptionGroupIdsIsNil applies the IsNil predicate on the "subscription_group_ids" field.
func SubscriptionGroupIdsIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldSubscriptionGroupIds))
}

// SubscriptionGroupIdsNotNil applies the NotNil predicate on the "subscription_group_ids" field.
func SubscriptionGroupIdsNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldSubscriptionGroupIds))
}
