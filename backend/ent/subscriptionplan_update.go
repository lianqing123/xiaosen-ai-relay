...
func (_u *SubscriptionPlanUpdate) SetIncludedGroupIds(v []int64) *SubscriptionPlanUpdate {
	_u.mutation.SetIncludedGroupIds(v)
	return _u
}

// AppendIncludedGroupIds appends value to the "included_group_ids" field.
func (_u *SubscriptionPlanUpdate) AppendIncludedGroupIds(v []int64) *SubscriptionPlanUpdate {
	_u.mutation.AppendIncludedGroupIds(v)
	return _u
}

// ClearIncludedGroupIds clears the value of the "included_group_ids" field.
func (_u *SubscriptionPlanUpdate) ClearIncludedGroupIds() *SubscriptionPlanUpdate {
	_u.mutation.ClearIncludedGroupIds()
	return _u
}
...
func (_u *SubscriptionPlanUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.IncludedGroupIds(); ok {
		_spec.SetField(subscriptionplan.FieldIncludedGroupIds, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedIncludedGroupIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, subscriptionplan.FieldIncludedGroupIds, value)
		})
	}
	if _u.mutation.IncludedGroupIdsCleared() {
		_spec.ClearField(subscriptionplan.FieldIncludedGroupIds, field.TypeJSON)
	}
...
// SetIncludedGroupIds sets the "included_group_ids" field.
func (_u *SubscriptionPlanUpdateOne) SetIncludedGroupIds(v []int64) *SubscriptionPlanUpdateOne {
	_u.mutation.SetIncludedGroupIds(v)
	return _u
}

// AppendIncludedGroupIds appends value to the "included_group_ids" field.
func (_u *SubscriptionPlanUpdateOne) AppendIncludedGroupIds(v []int64) *SubscriptionPlanUpdateOne {
	_u.mutation.AppendIncludedGroupIds(v)
	return _u
}

// ClearIncludedGroupIds clears the value of the "included_group_ids" field.
func (_u *SubscriptionPlanUpdateOne) ClearIncludedGroupIds() *SubscriptionPlanUpdateOne {
	_u.mutation.ClearIncludedGroupIds()
	return _u
}
