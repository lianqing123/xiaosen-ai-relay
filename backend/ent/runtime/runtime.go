...
func init() {
	...
	// userDescSubscriptionOveragePaygEnabled is the schema descriptor for subscription_overage_payg_enabled field.
	userDescSubscriptionOveragePaygEnabled := userFields[19].Descriptor()
	// user.DefaultSubscriptionOveragePaygEnabled holds the default value on creation for the subscription_overage_payg_enabled field.
	user.DefaultSubscriptionOveragePaygEnabled = userDescSubscriptionOveragePaygEnabled.Default.(bool)
