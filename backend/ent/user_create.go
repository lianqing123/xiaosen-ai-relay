...
// SetSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field.
func (_c *UserCreate) SetSubscriptionOveragePaygEnabled(v bool) *UserCreate {
	_c.mutation.SetSubscriptionOveragePaygEnabled(v)
	return _c
}

// SetNillableSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field if the given value is not nil.
func (_c *UserCreate) SetNillableSubscriptionOveragePaygEnabled(v *bool) *UserCreate {
	if v != nil {
		_c.SetSubscriptionOveragePaygEnabled(*v)
	}
	return _c
}
...
func (_c *UserCreate) defaults() error {
	...
	if _, ok := _c.mutation.SubscriptionOveragePaygEnabled(); !ok {
		v := user.DefaultSubscriptionOveragePaygEnabled
		_c.mutation.SetSubscriptionOveragePaygEnabled(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.SubscriptionOveragePaygEnabled(); !ok {
		return &ValidationError{Name: "subscription_overage_payg_enabled", err: errors.New(`ent: missing required field "User.subscription_overage_payg_enabled"`)}
	}
	if _, ok := _c.mutation.RpmLimit(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SubscriptionOveragePaygEnabled(); ok {
		_spec.SetField(user.FieldSubscriptionOveragePaygEnabled, field.TypeBool, value)
		_node.SubscriptionOveragePaygEnabled = value
	}
...
// SetSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field.
func (u *UserUpsert) SetSubscriptionOveragePaygEnabled(v bool) *UserUpsert {
	u.Set(user.FieldSubscriptionOveragePaygEnabled, v)
	return u
}

// UpdateSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field to the value that was provided on create.
func (u *UserUpsert) UpdateSubscriptionOveragePaygEnabled() *UserUpsert {
	u.SetExcluded(user.FieldSubscriptionOveragePaygEnabled)
	return u
}
...
// SetSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field.
func (u *UserUpsertOne) SetSubscriptionOveragePaygEnabled(v bool) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetSubscriptionOveragePaygEnabled(v)
	})
}

// UpdateSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateSubscriptionOveragePaygEnabled() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSubscriptionOveragePaygEnabled()
	})
}
...
// SetSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field.
func (u *UserUpsertBulk) SetSubscriptionOveragePaygEnabled(v bool) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetSubscriptionOveragePaygEnabled(v)
	})
}
...
// UpdateSubscriptionOveragePaygEnabled sets the "subscription_overage_payg_enabled" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateSubscriptionOveragePaygEnabled() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSubscriptionOveragePaygEnabled()
	})
}
