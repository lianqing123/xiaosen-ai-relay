...
func (_u *PaymentOrderUpdate) ClearSubscriptionGroupIds() *PaymentOrderUpdate {
	_u.mutation.ClearSubscriptionGroupIds()
	return _u
}
...
func (_u *PaymentOrderUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SubscriptionGroupIdsCleared() {
		_spec.ClearField(paymentorder.FieldSubscriptionGroupIds, field.TypeJSON)
	}
...
// ClearSubscriptionGroupIds clears the value of the "subscription_group_ids" field.
func (_u *PaymentOrderUpdateOne) ClearSubscriptionGroupIds() *PaymentOrderUpdateOne {
	_u.mutation.ClearSubscriptionGroupIds()
	return _u
}
