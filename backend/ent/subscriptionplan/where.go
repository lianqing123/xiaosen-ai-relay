...
func IncludedGroupIdsIsNil() predicate.SubscriptionPlan {
	return predicate.SubscriptionPlan(sql.FieldIsNull(FieldIncludedGroupIds))
}

// IncludedGroupIdsNotNil applies the NotNil predicate on the "included_group_ids" field.
func IncludedGroupIdsNotNil() predicate.SubscriptionPlan {
	return predicate.SubscriptionPlan(sql.FieldNotNull(FieldIncludedGroupIds))
}
