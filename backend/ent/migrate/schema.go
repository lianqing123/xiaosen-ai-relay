...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "preferred_subscription_group_id", Type: field.TypeInt64, Nullable: true},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "subscription_group_ids", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	SubscriptionPlansColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "included_group_ids", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "name", Type: field.TypeString, Size: 100},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "subscription_overage_payg_enabled", Type: field.TypeBool, Default: false},
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
	}
