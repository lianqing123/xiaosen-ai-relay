...
func (_u *APIKeyUpdate) SetPreferredSubscriptionGroupID(v int64) *APIKeyUpdate {
	_u.mutation.ResetPreferredSubscriptionGroupID()
	_u.mutation.SetPreferredSubscriptionGroupID(v)
	return _u
}

// SetNillablePreferredSubscriptionGroupID sets the "preferred_subscription_group_id" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillablePreferredSubscriptionGroupID(v *int64) *APIKeyUpdate {
	if v != nil {
		_u.SetPreferredSubscriptionGroupID(*v)
	}
	return _u
}

// AddPreferredSubscriptionGroupID adds value to the "preferred_subscription_group_id" field.
func (_u *APIKeyUpdate) AddPreferredSubscriptionGroupID(v int64) *APIKeyUpdate {
	_u.mutation.AddPreferredSubscriptionGroupID(v)
	return _u
}

// ClearPreferredSubscriptionGroupID clears the value of the "preferred_subscription_group_id" field.
func (_u *APIKeyUpdate) ClearPreferredSubscriptionGroupID() *APIKeyUpdate {
	_u.mutation.ClearPreferredSubscriptionGroupID()
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.PreferredSubscriptionGroupID(); ok {
		_spec.SetField(apikey.FieldPreferredSubscriptionGroupID, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.AddedPreferredSubscriptionGroupID(); ok {
		_spec.AddField(apikey.FieldPreferredSubscriptionGroupID, field.TypeInt64, value)
	}
	if _u.mutation.PreferredSubscriptionGroupIDCleared() {
		_spec.ClearField(apikey.FieldPreferredSubscriptionGroupID, field.TypeInt64)
	}
...
// SetPreferredSubscriptionGroupID sets the "preferred_subscription_group_id" field.
func (_u *APIKeyUpdateOne) SetPreferredSubscriptionGroupID(v int64) *APIKeyUpdateOne {
	_u.mutation.ResetPreferredSubscriptionGroupID()
	_u.mutation.SetPreferredSubscriptionGroupID(v)
	return _u
}
...
// SetNillablePreferredSubscriptionGroupID sets the "preferred_subscription_group_id" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillablePreferredSubscriptionGroupID(v *int64) *APIKeyUpdateOne {
	if v != nil {
		_u.SetPreferredSubscriptionGroupID(*v)
	}
	return _u
...
// AddPreferredSubscriptionGroupID adds value to the "preferred_subscription_group_id" field.
func (_u *APIKeyUpdateOne) AddPreferredSubscriptionGroupID(v int64) *APIKeyUpdateOne {
	_u.mutation.AddPreferredSubscriptionGroupID(v)
	return _u
}

// ClearPreferredSubscriptionGroupID clears the value of the "preferred_subscription_group_id" field.
func (_u *APIKeyUpdateOne) ClearPreferredSubscriptionGroupID() *APIKeyUpdateOne {
	_u.mutation.ClearPreferredSubscriptionGroupID()
	return _u
}
