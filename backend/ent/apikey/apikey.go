...
const (
	...
	// FieldPreferredSubscriptionGroupID holds the string denoting the preferred_subscription_group_id field in the database.
	FieldPreferredSubscriptionGroupID = "preferred_subscription_group_id"
...
var Columns = []string{
	...
	FieldName,
	FieldGroupID,
	FieldPreferredSubscriptionGroupID,
	FieldStatus,
	FieldLastUsedAt,
	FieldIPWhitelist,
	FieldIPBlacklist,
...
// ByPreferredSubscriptionGroupID orders the results by the preferred_subscription_group_id field.
func ByPreferredSubscriptionGroupID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPreferredSubscriptionGroupID, opts...).ToFunc()
}
