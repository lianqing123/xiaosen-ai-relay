...
// PreferredSubscriptionGroupID applies equality check predicate on the "preferred_subscription_group_id" field. It's identical to PreferredSubscriptionGroupIDEQ.
func PreferredSubscriptionGroupID(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldPreferredSubscriptionGroupID, v))
}
...
// PreferredSubscriptionGroupIDEQ applies the EQ predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDEQ(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDNEQ applies the NEQ predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDNEQ(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldNEQ(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDIn applies the In predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDIn(vs ...int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldIn(FieldPreferredSubscriptionGroupID, vs...))
}

// PreferredSubscriptionGroupIDNotIn applies the NotIn predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDNotIn(vs ...int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldNotIn(FieldPreferredSubscriptionGroupID, vs...))
}

// PreferredSubscriptionGroupIDGT applies the GT predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDGT(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldGT(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDGTE applies the GTE predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDGTE(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldGTE(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDLT applies the LT predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDLT(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldLT(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDLTE applies the LTE predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDLTE(v int64) predicate.APIKey {
	return predicate.APIKey(sql.FieldLTE(FieldPreferredSubscriptionGroupID, v))
}

// PreferredSubscriptionGroupIDIsNil applies the IsNil predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDIsNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldIsNull(FieldPreferredSubscriptionGroupID))
}

// PreferredSubscriptionGroupIDNotNil applies the NotNil predicate on the "preferred_subscription_group_id" field.
func PreferredSubscriptionGroupIDNotNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldNotNull(FieldPreferredSubscriptionGroupID))
}
